...
void main() =>
    runApp(const MyApp()); //menjalankan aplikasi dan menampilkan MyApp
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        //List Sederhana scroll vertikal
        child: ListView(
  ...
  Widget _buildHotPlaces() {
    ...
    return SizedBox(
      ...
      child: ListView.separated(
        //ListViewBuilder
        scrollDirection:
            Axis.horizontal, //bisa di scroll kanan horizontal list view
        padding: const EdgeInsets.symmetric(horizontal: 16),
        itemCount: places.length,
        separatorBuilder: (context, index) => const SizedBox(width: 12),
        itemBuilder: (context, index) {
          //menampilkan list tempat scra horizontal
          ...
          return Container(
            ...
            //menampilkan masing'' item dgn container
            child: Row(
              children: [
                ClipRRect(
...
class DetailPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    //menampilkan informasi lengkap tempat
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ClipRRect(
              borderRadius: BorderRadius.circular(12),
              child: Image.asset('assets/Panjang.png', fit: BoxFit.cover),
            ),
            const SizedBox(height: 16), //gambar besar
            const Text(
